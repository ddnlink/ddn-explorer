export default {
    ...
    'search.button': "搜索",
    'search.placeholder': "输入区块高度、交易ID或者账户地址",


    'home.height': "区块高度:",
    'home.supply': "积分总量:",
    'home.transfers': "账户总数:",
    'home.tokenAmount': "积分总量:",
    'home.transaction_count':'交换总数:',
    'home.init_time': "初始运行日期:",
    'home.run_time': "运行时间:",
    'home.latest_transactions': "最新交换",
    ...
    'home.assets':'存证类型占比',
    'home.no_data':'暂无数据',
    'home.aweek_title':'七天交易量',

    'block.id': "区块ID",
    'block.height': "区块高度",
    'block.numberOfTransactions': "交换数",
    'block.reward': "锻造奖励",
    'block.totalAmount': "交换量",
    'block.totalFee': "燃料",
    ...
    'block.version': "版本",
    'block.payloadLength': "交换数量",
    'block.payloadHash': "交易哈希",
