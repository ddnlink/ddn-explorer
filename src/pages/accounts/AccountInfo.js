...
class AccountInfo extends Component {
  ...
  onPublicKeyCopyClick = () => {
    ...
    message.success(i18n.formatMessage({ id: 'account.copyPublicKey' }));
  };

  onAddressCopyClick = () => {
    var copy1 = document.getElementById('addressCopy');
    copy(copy1.innerHTML);
    message.success(i18n.formatMessage({ id: 'account.copyAddress' }));
  };
      ...
      return (
        <div className={styles['accountHead']}>
          <div className={styles['accountScan']}>
            ...
            <div className={styles['qrdesc']}>{i18n.formatMessage({ id: 'account.scan' })}</div>
          </div>
              ...
              <tbody>
                <tr>
                  <td className={styles['col_one']}>
                    {i18n.formatMessage({ id: 'account.address' })}
                  </td>
                ...
                <tr>
                  <td className={styles['col_one']}>
                    {i18n.formatMessage({ id: 'account.balance' })}
                  </td>
                  <td className={styles['col_two']}>
                ...
                <tr>
                  <td className={styles['col_one']}>
                    {i18n.formatMessage({ id: 'account.unconfirmedBalance' })}
                  </td>
                  <td className={styles['col_two']}>
                ...
                <tr>
                  <td className={styles['col_one']}>
                    {i18n.formatMessage({ id: 'account.publicKey' })}
                  </td>
                  <td className={styles['col_two']}>
                    <span id="publicKeyCopy">{data.account.publicKey}</span>
                    <Icon
                      type="copy"
                      onClick={this.onPublicKeyCopyClick}
                      title="复制公钥"
                      className={styles['iconButton']}
                    />
                  </td>
                ...
                <tr>
                  <td className={styles['col_one']}>
                    {i18n.formatMessage({ id: 'account.lockHeight' })}
                  </td>
                  <td className={styles['col_two']}>
          ...
          <div className={styles['accountHead']}>
            <div style={{ width: '100%' }}>
              ...
              >
                ...
                {assets.map((item) => (
                  <Tabs.TabPane tab={item.currency} key={item.currency} />
                ))}
              </Tabs>
              <div
                className={styles['accountForm']}
                style={{ paddingTop: 10, display: 'flex', width: '100%' }}
              >
                <div className={styles['accountScan']} style={{ padding: 0 }}>
                  <img id={styles['imgQrCode']} src={qrImgUrl} className={styles['qrImg']} alt="" />
                  <div className={styles['qrdesc']}>
                    {i18n.formatMessage({ id: 'account.scan' })}
                  </div>
                </div>
                <div style={{ flex: 1 }}>
                  <table className={styles['accountTable']} style={{ width: '100%' }}>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className={styles['col_two']} id={styles['copy']}>
                          <span>
                            {this.state.data.account.unconfirmed_balance
                              ? this.state.data.account.unconfirmed_balance / 100000000
                              : 0}
                          </span>
                      ...
                      <tr>
                        ...
                        <td className={styles['col_two']}>
                          <span className={styles['unit']}>
                            {this.state.data.account.lock_height}
                          </span>
                        </td>
                      </tr>
                    </tbody>
