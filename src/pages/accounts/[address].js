...
<Radio.Group className={styles['radioGroup']} value={this.state.role} onChange={this.handleSizeChange}>
  <Radio.Button className={styles['radio']} value="all">{i18n.formatMessage({ id: 'account.all' })}</Radio.Button>
  <Radio.Button className={styles['radio']} value="recipient">{i18n.formatMessage({ id: 'account.recipient' })}</Radio.Button>
  <Radio.Button className={styles['radio']} value="sender">{i18n.formatMessage({ id: 'account.sender' })}</Radio.Button>
</Radio.Group>
</div>*/
