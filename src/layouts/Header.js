          ...
          <Col span={12}>
            ...
            >
              <Menu.Item key="1" className={styles.Menus_Item}>
                <NavLink to="/">{formatMessage({ id: "menu.home" })}</NavLink>
              </Menu.Item>
              <Menu.Item key="2" className={styles.Menus_Item}>
                <NavLink to="/blocks" > {formatMessage({ id: "menu.block" })}{" "} </NavLink>
              </Menu.Item>
          ...
          <Col span={2} className={styles.lang}>
            <Dropdown overlay={menuLang}>
              <a className="ant-dropdown-link" href="#">
                ...
                {formatMessage({ id: getLocale() })} <Icon type="down" />
              </a>
            </Dropdown>
          </Col>
        </Row>
