...
class AppFooter extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        {formatMessage({ id: "node.currentIP" })}
        <Popover
          content={
              ...
              >
                <div className={styles["select-container"]}>
                  <Input
                    ...
                    placeholder={formatMessage({ id: "node.setIP" })}
                  ...
                  >
                    {
                      ...
                      peersData.map(item => <div className={styles["option"]} key={item.ip} value={`${item.ip}:${item.port}`}>{this.secrecyShow(item.ip)}</div>)
                        :
                        <span>{formatMessage({ id: "not_content" })}</span>
                    }
                  </div>
                </div>
                <Button type="primary" style={{ marginTop: 30 }} onClick={this.hide}>
                  {formatMessage({ id: "node.done" })}
                </Button>
              </div>
            </Row>
          }
          title={formatMessage({ id: "node.setIP" })}
          trigger="click"
        ...
        <div style={{
          ...
          <div >
            <span className={`${styles['App-logo']} ${styles[`App-${localStorage.getItem("tokenName")}-logo`]}`} />
          </div>
          <div >
            ...
            <div style={{ textAlign: 'left', margin: '30px 0px 20px 0px' }}>
              <a href="javascript:void(0)" onClick={this.openWeixinBarcode} ref="weixinIcon">
                <img src={imgWeixin} width="24px" height="24px" alt="微信公众号" title="微信公众号" />
              </a>
              ...
              <a href="https://www.instagram.com/ddn_link/" target="_blank">
                <img src={imgInstagram} width="24px" height="24px" alt="Instagram" title="Instagram" />
              </a>
              <div style={{ width: '15px', display: 'inline-block' }}></div>
